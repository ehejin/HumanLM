Code repository for the paper, **"HUMANLM: Simulating Users with State Alignment Beats Response Imitation."**
This repository is a fork of VERL with an added recipe: `recipe/usim` for training/evaluating HUMANLM, a user simulator.

**Quickstart:** `bash recipe/usim/train_grpo.sh "0,1,2,3" reddit eval_only no "" "" base` 

Full instructions: see `recipe/usim/README.md`.
