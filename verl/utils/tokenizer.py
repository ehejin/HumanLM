...
def hf_tokenizer(name_or_path, correct_pad_token=True, correct_gemma2=True, **kwargs):
    ...
    # [USIM] if chat template path exists, use it
    multirole_chat_template_path = kwargs.get("multirole_chat_template_path")
    if multirole_chat_template_path:
        with open(multirole_chat_template_path, "r", encoding="utf-8") as f:
